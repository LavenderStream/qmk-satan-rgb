...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BW] = KEYMAP(
		...
		KC_RBRC,							KC_BSLS, KC_CAPS, KC_A,	 KC_S, KC_D, KC_F, KC_G,
		KC_H,								KC_J,	 KC_K,	 KC_L,	 KC_SCLN, KC_QUOT, KC_ENT,
		KC_LSFT,							KC_Z,	 KC_X,	 KC_C,	 KC_V, KC_B, KC_N, KC_M,
		KC_COMM,							KC_DOT,	 KC_SLSH, KC_UP, KC_LCTL, KC_LGUI,
		KC_LALT,							KC_SPC,	 F( 10 ), KC_LEFT, F( 11 ), KC_RGHT ),
	...
	[_FL] =
		KEYMAP(
			...
			KC_F8,							KC_F9,	 KC_F10, KC_F11, KC_F12, KC_DEL, KC_TRNS, F( 12 ),
			KC_UP,							F( 13 ), KC_TRNS, KC_INS, KC_TRNS, KC_TRNS, KC_TRNS,
			KC_TRNS,						KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
			KC_LEFT,						KC_DOWN, KC_RGHT, KC_TRNS, KC_HOME, KC_LEFT,
			KC_DOWN,						KC_UP,	 KC_RGHT, KC_HOME, KC_TRNS, KC_TRNS, KC_TRNS,
			KC_VOLD,						KC_VOLU, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
			KC_TRNS,						KC_TRNS, KC_TRNS, KC_END, KC_TRNS, KC_MPRV, KC_MPLY,
			KC_MNXT,						KC_TRNS, KC_DOWN, KC_LEFT, KC_TRNS, KC_RGHT ),
